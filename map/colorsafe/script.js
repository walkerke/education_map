...
map.on('load', function () {
    ...
    mychart.assignColor("Less than HS", "#d7191c");
    mychart.assignColor("High school", "#fdae61");
    mychart.assignColor("Some college", "#ffffbf");
    mychart.assignColor("Bachelor's", "#abd9e9");
    mychart.assignColor("Graduate", "#2c7bb6");
